...
lppub_file <- load_lppub_file(full_input_path, lppub_column_names, lppub_column_classes)
...
baseTable7 %>%
  ...
  data.table::fwrite(file.path(OUTDIR, paste0(fileYear, fileQtr, "_stat.csv")), sep = ",", na = "NULL", logical01 = TRUE, quote = TRUE, scipen = 100, col.names = TRUE, row.names = FALSE)
